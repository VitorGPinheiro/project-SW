...
`)+`
`+x);const U=L+M+u,D=L+x+f,I=zv(r,r.VERTEX_SHADER,U),F=zv(r,r.FRAGMENT_SHADER,D);r.attachShader(b,I),r.attachShader(b,F),n.index0AttributeName!==void 0?r.bindAttribLocation(b,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function P(k){if(o.debug.checkShaderErrors){const se=r.getProgramInfoLog(b)||"",ae=r.getShaderInfoLog(I)||"",de=r.getShaderInfoLog(F)||"",ue=se.trim(),B=ae.trim(),H=de.trim();let ie=!0,ye=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(ie=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,b,I,F);else{const xe=Vv(r,I,"vertex"),O=Vv(r,F,"fragment");nt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
